...
//자바 API 제공해주는 함수형 인터페이스 말고 내가 직접 설계하고
//싶다면 항수형 인터페이스를 만들어야한다


//@FunctionalInterface 은 인터페이스 안에 오직 단 하나의 추상 메서드만 가질수있도록 강제
@FunctionalInterface
...
public class Demo3 {
    ...
    public static void main(String[] args) {
        ...
        //주의 호출할떄는 참조 변수에 이름이 아니라 인터페이스의 정의된
        // 메서드 이름을 호출
